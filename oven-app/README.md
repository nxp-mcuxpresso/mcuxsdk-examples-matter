# CHIP NXP Oven Application

## Overview

The NXP Oven example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of an oven device which demonstrates device
commissioning and different cluster control.

### Supported platforms

The Oven example is supported on the following platforms :
