# CHIP NXP Microwave Oven Application

## Overview

The NXP Microwave Oven example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a microwave oven device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Microwave Oven example is supported on the following platforms :
