# CHIP NXP Cook Surface Application

## Overview

The NXP Cook Surface example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a cook surface device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Cook Surface example is supported on the following platforms :
