...
| `se05x_wifi_iw610_default_crypto` | Wi-Fi configuration with IW610 transceiver and SE05X secure element (Node Oper key in SE05X) | evkcmimxrt1060 | `prj_wifi.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y` |
| `se05x_wifi_iw610_default_crypto_factory_data` | Wi-Fi configuration with IW610 transceiver and SE05X secure element (Node Oper key and DA key in SE05X) | evkcmimxrt1060 | `prj_wifi_fdata.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y` |
| `se05x_thread_ftd_wifi_border_router_iw610_ota_default_crypto` | Thread FTD configuration with IW610 transceiver, Wi-Fi border router, OTA updates and SE05X secure element | evkcmimxrt1060 | `prj_thread_ftd_wifi_br_ota.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y` |
| `se05x_thread_ftd_wifi_border_router_iw610_ota_default_crypto_factory_data` | Thread FTD configuration with IW610 transceiver, Wi-Fi border router, OTA updates, factory data and SE05X secure element | evkcmimxrt1060 | `prj_thread_ftd_wifi_br_ota_fdata.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y` |
| `se05x_wifi_iw610_default_crypto_gpio` | Wi-Fi configuration with IW610 transceiver and SE05X secure element (Node Oper key in SE05X) with host GPIO control for SE05X power on/off and to get the GPIO notification. Refer [NXP SE05X Guide](../../../middleware/matter/docs/platforms/nxp/nxp_se05x_guide.md) for connections details. | evkcmimxrt1060 | `prj_wifi.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y`<br>`-DCONFIG_SE05X_HOST_GPIO=y` |
| `se05x_wifi_default_crypto_gpio` | Wi-Fi configuration with SE05X secure element (Node Oper key in SE05X) along with GPIO control for SE05X power on/off and to get the GPIO notification. Refer [NXP SE05X Guide](../../../middleware/matter/docs/platforms/nxp/nxp_se05x_guide.md) for connections details. | frdmrw612 | `prj_wifi.conf` | `-DCONFIG_CHIP_SE05X=y`<br>`-DCONFIG_SE05X_HOST_GPIO=y` |
| `se05x_aes_key_wifi_default_crypto` | Wi-Fi configuration with SE05X secure element (Node Oper key in SE05X) using AES key secure session | frdmrw612 | `prj_wifi.conf` | `-DCONFIG_CHIP_SE05X=y`<br>`-DCONFIG_SE05X_AES_KEY=y` |
| `se05x_scp03_wifi_default_crypto` | Wi-Fi configuration with SE05X secure element (Node Oper key in SE05X) using secure channel protocol support | frdmrw612 | `prj_wifi.conf` | `-DCONFIG_CHIP_SE05X=y`<br>`-DCONFIG_SE05X_SCP03=y` |
| `se05x_aes_key_wifi_iw610_default_crypto` | Wi-Fi configuration with IW610 transceiver and SE05X secure element (Node Oper key in SE05X) using AES key session | evkcmimxrt1060 | `prj_wifi.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y`<br>`-DCONFIG_SE05X_AES_KEY=y` |
| `se05x_scp03_wifi_iw610_default_crypto` | Wi-Fi configuration with IW610 transceiver and SE05X secure element (Node Oper key in SE05X) using secure channel protocol support | evkcmimxrt1060 | `prj_wifi.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y`<br>`-DCONFIG_SE05X_SCP03=y` |
| `thread_ftd_el2go_ota` | Thread FTD configuration with EL2GO factory data and OTA updates | frdmrw612, rdrw612bga | `prj_thread_ftd_fdata_el2go_ota.conf` | None |
