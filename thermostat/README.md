...
| `se05x_wifi_iw610_default_crypto` | Wi-Fi configuration with IW610 transceiver and SE05X secure element | evkcmimxrt1060 | `prj_wifi.conf` | `-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.IW61X=y`<br>`-DCONFIG_MCUX_COMPONENT_component.wifi_bt_module.board_murata_2ll_m2=y`<br>`-DCONFIG_CHIP_SE05X=y` |
