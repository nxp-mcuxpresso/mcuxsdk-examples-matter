# CHIP NXP Pump Application

## Overview

The NXP Pump example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a pump device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Pump example is supported on the following platforms :
