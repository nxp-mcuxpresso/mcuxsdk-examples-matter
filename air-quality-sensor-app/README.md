# CHIP NXP Air Quality Sensor Application

## Overview

The NXP Air Quality Sensor example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of an air quality sensor device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Air Quality Sensor example is supported on the following platforms :
