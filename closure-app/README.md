# CHIP NXP Closure Application

## Overview

The NXP Closure example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a closure device which demonstrates device
commissioning and different cluster control.

### Supported platforms

The Closure example is supported on the following platforms :
