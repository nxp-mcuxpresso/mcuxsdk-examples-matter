# CHIP NXP Dishwasher Application

## Overview

The NXP Dishwasher example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a dishwasher device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Dishwasher example is supported on the following platforms :
