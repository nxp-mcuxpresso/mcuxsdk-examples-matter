# CHIP NXP Temperature Measurement Application

## Overview

The NXP Temperature Measurement example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a temperature sensor device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Temperature Measurement example is supported on the following platforms :
