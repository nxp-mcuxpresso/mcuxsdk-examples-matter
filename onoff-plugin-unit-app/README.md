# CHIP NXP On-off Plugin Unit Application

## Overview

The NXP On-off Plugin Unit example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of an on-off plugin unit device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The On-off Plugin Unit example is supported on the following platforms :
