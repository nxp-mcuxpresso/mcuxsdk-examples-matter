# CHIP NXP Chime Application

## Overview

The NXP Chime example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a chime device which demonstrates device
commissioning and different cluster control.

### Supported platforms

The Chime example is supported on the following platforms :
