# CHIP NXP Occupancy Sensor Application

## Overview

The NXP Occupancy Sensor example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of an occupancy sensor device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Occupancy Sensor example is supported on the following platforms :
