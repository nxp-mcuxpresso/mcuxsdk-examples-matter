...
| `thread_mtd_low_power_lit`                                      | Thread MTD and Matter ICD LIT configuration with low power optimization                 | frdmmcxw71, frdmmcxw72@cm33_core0, mcxw72evk@cm33_core0 | `prj_thread_mtd_low_power_lit.conf`       | `-DCONFIG_MCUX_COMPONENT_middleware.freertos-kernel.config=n`                                                                                                                                                                                                                                                    |
